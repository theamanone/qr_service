...
import { deleteAccount } from "@/utils/apiHandlers";
    ...
    <div className="min-h-screen bg-gray-100 text-black">
      ...
      <main className="p-4 lg:p-8">
        ...
        <section className="bg-white shadow-md rounded-lg p-6">
          <h3 className="text-lg font-medium text-gray-800 mb-4">Profile Actions</h3>
          {!isEditing ? (
            <div>
            ...
            >
              ...
              <div onClick={() => alert('The email address cannot be changed at this time. This feature will be available in the future.')}>
              ...
              <div className="flex space-x-2">
                <button
                  ...
                  className={`w-full py-2 rounded-md shadow-md ${isSaveEnabled
